...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Linh - Trường Tiểu học Minh Dân - ĐT: 0372799284</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -   <p>Tác giả:Hoàng Thị Linh - Trường Tiểu học Minh Dân - ĐT: 0372799284</p></div>", unsafe_allow_html=True)
